...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    deliverables: [
      ...
      "Fast Global Edge Hosting TechGrowXp + Free SSL",
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Google Analytics 4 & Meta Conversion Pixel TechGrowXp",
  ...
  },
  {
    ...
    description: "The complete TechGrowX client acquisition and automation system. Includes advanced landing pages, calendar scheduling, automated WhatsApp reminder sequences, and custom workflow automations.",
    deliverables: [
